# Phase 5.3: Trace / Debug Utilities
import numpy as np
...
def training_progress(step, loss, baseline_loss, lr):
    """Return training progress summary."""
    return {"step": step, "loss": float(loss), "baseline": float(baseline_loss),
            "lr": lr, "improvement": float(baseline_loss - loss)}
