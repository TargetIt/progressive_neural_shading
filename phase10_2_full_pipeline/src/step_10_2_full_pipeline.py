# Phase 10.2: Full Pipeline (= network step_05)
# ==============================================
# Neural texture compression with latent optimization.
# Full training loop optimizes both latent texture and network weights.
#
# Run: python src/step_10_2_full_pipeline.py
...
app = App(width=512 * 3 + 10 * 2, height=512, title="Phase 10.2: Full Pipeline")
module = spy.Module.load_from_file(app.device, "step_10_2_full_pipeline.slang")
