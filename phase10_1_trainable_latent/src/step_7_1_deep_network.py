# Phase 7.1: Deep Network Training (= network step_02)
# =====================================================
# Multi-layer MLP (2->32->32->3) with full training loop.
#
# Run: python src/step_7_1_deep_network.py
...
app = App(width=512 * 3 + 10 * 2, height=512, title="Phase 7.1: Deep Network Training")
module = spy.Module.load_from_file(app.device, "step_7_1_deep_network.slang")
