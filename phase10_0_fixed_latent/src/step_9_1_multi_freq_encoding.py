# Phase 9.1: Multi-Freq Encoding (= network step_04)
# ===================================================
# Multi-frequency sin+cos positional encoding + neural network.
# 4 octaves -> 16 encoded inputs -> 32 -> 32 -> 3 MLP
#
# Run: python src/step_9_1_multi_freq_encoding.py
...
app = App(width=512 * 3 + 10 * 2, height=512, title="Phase 9.1: Multi-Freq Encoding")
module = spy.Module.load_from_file(app.device, "step_9_1_multi_freq_encoding.slang")
