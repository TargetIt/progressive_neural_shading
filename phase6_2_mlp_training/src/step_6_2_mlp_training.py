# Phase 6.2: MLP Training (= network step_01)
# ============================================
# Full neural network training loop with:
#   - NetworkParameters with atomic gradient accumulation
#   - Adam optimizer
#   - LCG stochastic sampling
#   - 2 inputs (uv) -> 3 outputs (RGB) network
#
# Trains a single-layer MLP to match slangstars.png.
#
# Run: python src/step_6_2_mlp_training.py
...
app = App(width=512 * 3 + 10 * 2, height=512, title="Phase 6.2: MLP Training")
module = spy.Module.load_from_file(app.device, "step_6_2_mlp_training.slang")
